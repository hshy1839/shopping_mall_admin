...
//                     `http://15.164.155.205:8865/api/qnaQuestion/getinfoByid/${id}`,
//                     {
//                         headers: {
...
//                 const response = await axios.get(
//                     `http://15.164.155.205:8865/api/qnaQuestion/getAnswers/${id}`,
//                     {
//                         headers: {
//                             Authorization: `Bearer ${token}`,
//                         },
...
//                 `http://15.164.155.205:8865/api/qnaQuestion/addAnswer/${id}`,
//                 { body: newAnswer },
//                 {
//                     headers: {
//                         Authorization: `Bearer ${token}`,
