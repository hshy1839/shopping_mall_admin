...
const Promotion = () => {
    ...
    const fetchPromotions = async () => {
        try {
            ...
            const response = await axios.get('http://15.164.155.205:8865/api/promotion/read', {
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            const response = await axios.delete(`http://15.164.155.205:8865/api/promotion/delete/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
