...
const Coupon = () => {
    ...
    const fetchCoupons = async () => {
        try {
            ...
            const response = await axios.get('http://3.104.4.81:8865/api/coupons', {
                headers: {
 ...
 const handleCreateCouponClick = () => {
    ...
    const handleToggleActive = async (id, isActive) => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://3.104.4.81:8865/api/coupon/${id}`,
                { isActive },
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            const response = await axios.delete(`http://3.104.4.81:8865/api/coupon/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
